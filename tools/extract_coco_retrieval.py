...
if __name__ == '__main__':
    ...
    #     copyfile(path, os.path.join("cocotext_top500_retrieval/images",imgname))
    #     f = open("cocotext_top500_retrieval/gts/{}".format(imgname.replace(".jpg",".txt")),'w')
    #     str_line = ""
    #     for word in imgname_words[imgname]:
    #         # print(imgname,len(imgname_words[imgname]))
    #         f.write(word+'\n')
    # print(len(os.listdir("cocotext_top500_retrieval/images")),len(os.listdir("cocotext_top500_retrieval/gts")))
