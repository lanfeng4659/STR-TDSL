...
if __name__ =='__main__':
    predictions = torch.load("./Log/retrival_e2e_add_retrieval_loss_10_colorjit_wordaug_b64_have_centerness_vot_veri_640/inference/cocotext_test/predictions.pth")
