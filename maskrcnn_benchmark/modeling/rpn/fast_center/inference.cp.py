...
class FCOSPostProcessor(torch.nn.Module):
    ...
    def forward_for_single_feature_map(
            ...
            box_regression, poly_regression, centerness, image_sizes, offsets=None):
        """
        Arguments:
    ...
    def forward(
            ...
            poly_regression, centerness, image_sizes):
        """
        Arguments:
        ...
        for i, (l, o, b, z, c) in enumerate(zip(
                locations, box_cls, box_regression, poly_regression, centerness)):
            """
            if len(f) == 0:
                f = None
            else:
