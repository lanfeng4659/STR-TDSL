...
class RetrivalLossComputation(object):
    ...
    def prepare_targets(self, points, targets):
        ...
        # )
        labels, reg_targets, is_in_bboxes = self.compute_targets_for_locations(
            points_all_level, targets, expanded_object_sizes_of_interest
        )
        ...
        return labels_level_first, reg_targets_level_first, is_in_bboxes#bezier_targets_level_first
    ...
    def compute_targets_for_locations(self, locations, targets, object_sizes_of_interest):
        ...
        return labels, reg_targets, labels[0]#bezier_targets
    ...
    def __call__(self, locations, box_cls, box_regression, centerness, targets):
        ...
        return cls_loss, reg_loss, centerness_loss,is_in_bboxes
